...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim technique practice, endurance training, and friendly meets",
    ...
    "Science Olympiad": {
        "description": "Hands-on science challenges and preparation for academic competitions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
